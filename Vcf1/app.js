...
const VCF_RELEASE_DATE = new Date(2026, 5, 30, 23, 59); // June 30, 2026 11:59 PM

// Complete country calling codes list
const COUNTRY_CODES = [
...
document.getElementById('contactForm').addEventListener('submit', function(e) {
    ...
    // Phone validation: digits only, no +, minimum length 5
    ...
    // Duplicate checks (only if format is valid)
    if (valid) {
